                ...
                <div>
                    <div className="mb-[14px] text-justify lg:text-left">
                        <div className="flex flex-row gap-2">
                            <p>Este projeto tem apenas objetivo de desafiar as capacidades no desenvolvimento de uma interface semelhante à </p>
                            <Link href="http://netflix.com/" target="_blank">
                                <p className="underline">Netflix.</p>
                            </Link>
                        </div>
